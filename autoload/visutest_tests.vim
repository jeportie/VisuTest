...
"    Updated: 2024/09/22 12:27:10 by jeportie         ###   ########.fr        "
"                                                                              "
" **************************************************************************** "

" Function to get test units inside each .c file in test_src/
function! visutest#GetTestUnits(suite_file)
  let l:test_units = []
...
function! visutest#GetTestSuites()
  let l:test_suites = []
...
function! visutest#DisplayTestSuites()
  setlocal modifiable
  execute '%delete _'
  ...
  call visutest#SetupHighlighting()

  call append(line('$'), '-------- Test Suites --------')
  call append(line('$'), '')

  let l:test_suites = visutest#GetTestSuites()
  if empty(l:test_suites)
    ...
    for l:suite_file in l:test_suites
      ...
      let l:test_units = visutest#GetTestUnits(l:suite_file)
...
function! visutest#GetSelectedSuite()
...
function! visutest#ShowUnits()
  " Get the selected suite name
  let l:suite_name = visutest#GetSelectedSuite()
